...
export async function executeRoutedTask(root, options) {
...
export function validateMetareviewText(text) {
...
export async function runAutomatedMetareview(root, options) {
    const reviewPrompt = [
...
async function runClaudeLike(command, prompt, cwd) {
